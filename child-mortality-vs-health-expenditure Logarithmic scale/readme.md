# Child mortality vs. health spending - Data package

This data package contains the data that powers the chart ["Child mortality vs. health spending"](https://ourworldindata.org/grapher/child-mortality-vs-health-expenditure?time=2019&overlay=download-data&v=1&csvType=filtered&useColumnShortNames=false) on the Our World in Data website.
...
#### In-line citation
If you have limited space (e.g. in data visualizations), you can use this abbreviated in-line citation:  
World Health Organization Global Health Expenditure Database, via World Bank (2025) – processed by Our World in Data

#### Full citation
World Health Organization Global Health Expenditure Database, via World Bank (2025) – processed by Our World in Data. “Current health expenditure per capita, PPP” [dataset]. World Health Organization Global Health Expenditure Database, via World Bank, “World Development Indicators 122” [original data].
Source: World Health Organization Global Health Expenditure Database, via World Bank (2025) – processed by Our World In Data

### How is this data described by its producer - World Health Organization Global Health Expenditure Database, via World Bank (2025)?
...
#### World Health Organization Global Health Expenditure Database, via World Bank – World Development Indicators
