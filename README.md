...
1. Open `4-R-Project-data Visualization.Rmd` in RStudio
2. Make sure the dataset folder is in the same directory as the .Rmd file
3. Knit the file to HTML (or PDF)
4. Explore the plots and outputs; the HTML version allows better interactivity